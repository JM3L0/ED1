...
void separa_impar_par(FILA* fila, FILA* impar, FILA* par);

int main(){

    FILA* fila = criar_fila();
    FILA* fila_par = criar_fila();
    FILA* fila_impar = criar_fila();
    ...
    separa_impar_par(fila, fila_impar, fila_par);

    mostrar_fila(fila_par);
    mostrar_fila(fila_impar);
    
    fila = liberar_fila(fila);
    fila_par = liberar_fila(fila_par);
    fila_impar = liberar_fila(fila_impar);
